...
async def regenerate_assistant(
    ...
    *,
    ...
    new_msg = await conv_service.append(
        session,
        session_id,
        AppendMessageDraft(
            role="assistant",
    ...
    await conv_service.touch(session, session_id)
...
async def edit_and_resend(
    ...
    *,
    ...
    new_user = await conv_service.append(
        session,
        session_id,
        AppendMessageDraft(
            role="user",
    ...
    result = await provider.invoke(ctx)
    new_assistant = await conv_service.append(
        session,
        session_id,
        AppendMessageDraft(
            role="assistant",

...
# 运行时协议类型的完整导出（供 chameleon.providers.base.types re-export，含下划线名）
__all__ = [
    "Role", "TextBlock", "ImageUrlBlock", "AudioUrlBlock", "ContentBlock",
    "_ImageUrl", "_AudioUrl", "normalize_content", "flatten_to_text",
    "Message", "AgentDef", "RESERVED_CONTEXT_PREFIX", "sanitize_context_vars",
    "InvokeContext", "StepRecord", "Citation", "ToolCallRecord", "Usage",
    "StreamEventType", "StreamEvent", "InvokeResult", "_StreamAggregator",
]

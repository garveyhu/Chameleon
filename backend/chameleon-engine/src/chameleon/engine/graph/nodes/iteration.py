...
from chameleon.engine.graph.nodes._subgraph import (
    MAX_NEST_DEPTH,
    ensure_nest_depth,
    run_subgraph,
)
from chameleon.engine.graph.nodes.if_else import eval_condition, validate_condition
...
class IterationNode(Node[Any, dict]):
    ...
    def validate_data(self, data: dict[str, Any]) -> None:
        ...
        try:
            ...
            from chameleon.engine.graph.types import GraphSpec
